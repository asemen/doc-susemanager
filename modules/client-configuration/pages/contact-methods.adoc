...
For more information about bootstrapping, see xref:client-configuration:registration-bootstrap.adoc[Registering Clients with a Bootstrap Script].

The bootstrap script will need to have an activation key associated with it that is configured for Push via SSH.
For more information on activation keys, see xref:client-configuration:clients-and-activation-keys.adoc[Activation keys].
...
For more information about Salt SSH, see xref:salt:salt-ssh.adoc[Salt SSH].
...
For more information about activation keys, see xref:client-configuration:clients-and-activation-keys.adoc[Activation keys].
